...
export function HomePage() {
  ...
  return (
    <Flex vertical>
      <p>Whisper Grid is a decentralized messaging system.</p>
      <ul>
        <li>
        ...
        <li>
          ...
          backup in{" "}
          <Typography.Link href={settingsHref}>
            <SettingOutlined />
            Settings
          </Typography.Link>
          .
      ...
      <Button href={createHref}>
        <PlusOutlined /> Create Invitation
      </Button>
      <Typography.Text>
      ...
      <Button href={replyHref}>
        <SendOutlined /> Reply to invite
      </Button>
      <Typography.Text>
