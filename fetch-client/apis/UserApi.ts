...
export class UserApi extends runtime.BaseAPI {
     ...
     */
    async getBackupRaw(requestParameters: GetBackupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
     ...
     * Get password-protected backup by backupKey
     */
    async getBackup(requestParameters: GetBackupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
     ...
     */
    async getLoginChallengeRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        const queryParameters: any = {};
     ...
     * Get a login challenge
     */
    async getLoginChallenge(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
     ...
     */
    async loginWithChallengeRaw(requestParameters: LoginWithChallengeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
     ...
     * Login with a challenge
     */
    async loginWithChallenge(requestParameters: LoginWithChallengeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
     ...
     */
    async uploadBackupRaw(requestParameters: UploadBackupOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['backupKey'] == null) {
            throw new runtime.RequiredError(
                'backupKey',
     ...
     * Upload a password-protected backup
     */
    async uploadBackup(requestParameters: UploadBackupOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
