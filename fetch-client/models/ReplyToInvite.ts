...
export function instanceOfReplyToInvite(value: object): value is ReplyToInvite {
    if (!('replyToInvite' in value) || value['replyToInvite'] === undefined) return false;
    return true;
}
...
export function ReplyToInviteFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReplyToInvite {
    if (json == null) {
        return json;
    }
    return {
