...
* returns String
* */
const getInvite = ({ thumbprint }) => new Promise(
...
* returns List
* */
const getThread = ({ threadId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        threadId,
...
* returns String
* */
const publishInvite = ({ invite }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        invite,
...
* returns String
* */
const publishReply = ({ threadId, publishReplyRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        threadId,
...
* */
const replyToInvite = ({ thumbprint, replyToInvite }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        thumbprint,
