...
* returns String
* */
const getBackup = ({ backupKey }) => new Promise(
...
* returns String
* */
const getLoginChallenge = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
...
* returns String
* */
const loginWithChallenge = ({ signedChallenge }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        signedChallenge,
...
* returns String
* */
const uploadBackup = ({ backupKey, uploadBackupRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        backupKey,
